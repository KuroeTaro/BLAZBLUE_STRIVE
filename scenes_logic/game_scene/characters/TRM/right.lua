...
function load_game_scene_obj_char_RP()
    ...
    -- 5H_shot_sys
        -- oroboros
    obj_char_game_scene_char_RP["5H_oroboros_state"] = "off"
    obj_char_game_scene_char_RP["5H_oroboros_aim_process"] = {0,420,480,540}
    obj_char_game_scene_char_RP["5H_oroboros_aim_r"] = 0
    obj_char_game_scene_char_RP["5H_oroboros_f"] = 0
    obj_char_game_scene_char_RP["5H_oroboros_animation_table"] = {}
    obj_char_game_scene_char_RP["5H_oroboros_fire_cancel"] = false
    obj_char_game_scene_char_RP["5H_oroboros_idle_cancel"] = false
            -- sub_obj
    obj_char_game_scene_char_RP["5H_oroboros_front"] = {0,0,0,0,1,1,0,0}
    obj_char_game_scene_char_RP["5H_oroboros_front"]["f_8"] = 0
    obj_char_game_scene_char_RP["5H_oroboros_front"]["f_4"] = 0
    obj_char_game_scene_char_RP["5H_oroboros_front"]["sprite_sheet_state"] = "5H_oroboros_loop_front"
    obj_char_game_scene_char_RP["5H_oroboros_mid"] = {0,0,0,0,1,1,0,0}
    obj_char_game_scene_char_RP["5H_oroboros_mid"]["f_8"] = 0
    obj_char_game_scene_char_RP["5H_oroboros_mid"]["sprite_sheet_state"] = "5H_oroboros_loop_mid"
    obj_char_game_scene_char_RP["5H_oroboros_back"] = {0,0,0,0,1,1,0,0}
    obj_char_game_scene_char_RP["5H_oroboros_back"]["f_8"] = 0
    obj_char_game_scene_char_RP["5H_oroboros_back"]["f_4"] = 0
    obj_char_game_scene_char_RP["5H_oroboros_back"]["sprite_sheet_state"] = "5H_oroboros_loop_back"
            -- update_value
    obj_char_game_scene_char_RP["5H_oroboros_offset_amount"] = 0
    obj_char_game_scene_char_RP["5H_oroboros_anchor_pos"] = {-110,-455}
    obj_char_game_scene_char_RP["5H_oroboros_ease_current"] = {
        obj_char_game_scene_char_RP["x"] + obj_char_game_scene_char_RP[5] * obj_char_game_scene_char_RP["5H_oroboros_anchor_pos"][1],
        obj_char_game_scene_char_RP["y"] + obj_char_game_scene_char_RP[6] * obj_char_game_scene_char_RP["5H_oroboros_anchor_pos"][2],
        obj_char_game_scene_char_RP[5],
        obj_char_game_scene_char_RP[6]
    }
    obj_char_game_scene_char_RP["5H_oroboros_ease_target"] = {
        obj_char_game_scene_char_RP["x"] + obj_char_game_scene_char_RP[5] * obj_char_game_scene_char_RP["5H_oroboros_anchor_pos"][1],
        obj_char_game_scene_char_RP["y"] + obj_char_game_scene_char_RP[6] * obj_char_game_scene_char_RP["5H_oroboros_anchor_pos"][2],
        obj_char_game_scene_char_RP[5],
        obj_char_game_scene_char_RP[6]
        ...
        -- reticle
    obj_char_game_scene_char_RP["5H_reticle"] = {0,0,0,1,1,1,0,0}
    obj_char_game_scene_char_RP["5H_reticle_f"] = 0
    obj_char_game_scene_char_RP["5H_reticle_state"] = "off"
    obj_char_game_scene_char_RP["5H_reticle_animation"] = nil
    obj_char_game_scene_char_RP["5H_reticle_visual_offset_amount_target"] = 0
    obj_char_game_scene_char_RP["5H_reticle_visual_offset_amount_current"] = 0
    obj_char_game_scene_char_RP["5H_reticle_visual_offset"] = {0,0}
    obj_char_game_scene_char_RP["5H_reticle_sprite_sheet_state"] = "5H_reticle_at_the_ready"
