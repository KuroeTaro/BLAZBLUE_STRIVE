...
function state_gate_game_scene_char_RP_common_ground_to_dash_move_hold_ver_all(input,obj_char)
    -- direction_input
    if not common_game_scene_get_character_facing_currect(obj_char,common_game_scene_change_character(obj_char["player_side"])) and test_input_sys_press_or_hold(input["dash"]) then
...
function state_gate_game_scene_char_RP_common_to_burst_overdrive(input,self_side_obj_char,type)
    -- _overdrive
...
function state_gate_game_scene_char_RP_from_throw_success(input,self_side_obj_char)
    local obj_stage_main = obj_stage_game_scene_main
    local opponent_side_obj_char = common_game_scene_change_character(self_side_obj_char["player_side"])
    local obj_camera = obj_stage_game_scene_camera
    -- _overdrive
    if self_side_obj_char["hit_cancel"] and state_gate_game_scene_char_RP_common_to_burst_overdrive(input,self_side_obj_char,"overdrive") then
        return true
    end
    -- _RRC
    if self_side_obj_char["hit_cancel"] and state_gate_game_scene_char_RP_common_to_burst_RC_red(input,self_side_obj_char) then
        return true
    end
    -- _PRC
    if not self_side_obj_char["hit_cancel"] and state_gate_game_scene_char_RP_common_to_burst_RC_purple(input,self_side_obj_char) then
    ...
    if get_character_anim_end_state(self_side_obj_char,self_side_obj_char["character_animation"]) then
        ...
        -- _common_ground_idle_to_move
        if state_gate_game_scene_char_RP_common_ground_to_dash_move_hold_ver_all(input,self_side_obj_char) then
            return true
        end
        -- 5_stand_idle
        if state_gate_game_scene_char_RP_from_5_stand_idle(input,self_side_obj_char) then
            return true
        end
        return
    end
    ...
    if self_side_obj_char["idle_cancel"] then
        ...
        if self_side_obj_char["height"] == "air" then
            -- _common_air_to_move
            if state_gate_game_scene_char_RP_common_air_to_dash_move_hold_ver_all(input,self_side_obj_char) then
                return true
            end
            -- 7_8_9_jump_air
            if state_gate_game_scene_char_RP_from_7_8_9_jump_air(input,self_side_obj_char) then
                return true
            end
        -- stand_idle
...
function state_gate_game_scene_char_RP_from_throw_testing(input,self_side_obj_char)
    local opponent_side_obj_char = common_game_scene_change_character(self_side_obj_char["player_side"])
    ...
    elseif self_side_obj_char["f"] > 9 then
        ...
        state_gate_game_scene_char_RP_from_throw_success(input,self_side_obj_char)
        -- insert_VFX
...
function state_gate_game_scene_char_RP_from_throw_tested(input,self_side_obj_char)
    local opponent_side_obj_char = common_game_scene_change_character(self_side_obj_char["player_side"])
    self_side_obj_char["f"] = self_side_obj_char["f"] + 1
...
function state_gate_game_scene_char_RP_from_burst_RC_red(input,self_side_obj_char)
    local opponent_side_obj_char  = common_game_scene_change_character("R")
    if self_side_obj_char["idle_cancel"] then
        if self_side_obj_char["height"] == "air" then
            -- _common_air_idle_to_move
            if state_gate_game_scene_char_RP_common_air_to_special_move_hold_ver(input,self_side_obj_char) then
            ...
            if state_gate_game_scene_char_RP_common_air_to_attack_move_hold_ver(input,self_side_obj_char) then
                common_game_scene_game_speed_load_application(self_side_obj_char,{1,nil,nil,nil,0,nil})
                common_game_scene_game_speed_load_application(opponent_side_obj_char ,{1,2,1,19,0,nil})
                self_side_obj_char["heat_penalty"] = 0.1
                self_side_obj_char["heat_penalty_countdown"] = 120
            ...
            -- _common_ground_idle_to_move
            if state_gate_game_scene_char_RP_common_ground_to_attack_move_hold_ver(input,self_side_obj_char) then
                common_game_scene_game_speed_load_application(self_side_obj_char,{1,nil,nil,nil,0,nil})
                common_game_scene_game_speed_load_application(opponent_side_obj_char ,{1,2,1,19,0,nil})
                self_side_obj_char["heat_penalty"] = 0.1
                self_side_obj_char["heat_penalty_countdown"] = 120
...
function state_gate_game_scene_char_RP_from_burst_RC_blue(input,self_side_obj_char)
    local opponent_side_obj_char  = common_game_scene_change_character("R")
    if self_side_obj_char["idle_cancel"] then
        if self_side_obj_char["height"] == "air" then
            -- _common_air_idle_to_move
...
function state_gate_game_scene_char_RP_from_burst_RC_purple(input,self_side_obj_char)
    local opponent_side_obj_char = common_game_scene_change_character("R")
    if self_side_obj_char["idle_cancel"] then
        if self_side_obj_char["height"] == "air" then
            -- _common_air_idle_to_move
