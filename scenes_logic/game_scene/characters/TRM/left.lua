...
function load_game_scene_obj_char_LP()
    ...
    obj_char_game_scene_char_LP["shot_sys_aim_process"] = {0,0,420,540,false} -- 当前值 当前速度 瞄准命中最低值 瞄准命中最高保存值 上一帧是否高于瞄准命中最低数值
    ...
    obj_char_game_scene_char_LP["shot_sys_reticle_offset_r"] = 0
