...
function load_game_scene_obj_char_LP()
    ...
    obj_char_game_scene_char_LP["shot_sys_steady_aim_quick_clean_hit_state"] = {
        ["hurt"] = true,
        ["throw_hurt_success"] = true,
        ["hurtstop"] = true,
        ["wallstick"] = true,
    ...
    obj_char_game_scene_char_LP["shot_sys_steady_aim_quick_clean_hit_from_at_the_ready_state"] = {
        ["block"] = true,
        ["blockstop"] = true
    }
    -- shot_sys_oroboros
