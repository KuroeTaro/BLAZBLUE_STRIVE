...
function insert_VFX_game_scene_char_TRM_5H_at_the_ready_projectile_hit_blast(hit_side_obj_char,hurt_side_obj_char)
    ...
    obj["life"] = 16
    obj[1] = hit_side_obj_char["shot_sys_reticle"][1] - 230 + 160
    obj[2] = hit_side_obj_char["shot_sys_reticle"][2] - 255 + 160
    obj[3] = 0
    obj[4] = 1
    obj[5] = 1
    obj[6] = 1
    ...
    table.insert(hit_side_obj_char["VFX_hit_front_table"],obj)
end
...
function insert_VFX_game_scene_char_TRM_6SP_P_arua(hit_side_obj_char,hurt_side_obj_char)
    ...
    if hurt_side_obj_char["height"] == "air" then
        obj["y_offset"] = 375 + hurt_side_obj_char["pushbox"][4]/4*3
    elseif hurt_side_obj_char["height"] == "wallstick" then
        obj["y_offset"] = 350 + hurt_side_obj_char["pushbox"][4]/4*3
    else
        obj["y_offset"] = 400 + hurt_side_obj_char["pushbox"][4]/4*3
    end
    ...
    obj["LCD"] = {0,0,0,0,0,0,0,0}
    obj["life"] = 42
    obj[1] = hurt_side_obj_char["x"] - 400
    obj[2] = math.min(hurt_side_obj_char["y"] - hurt_side_obj_char[6]*obj["y_offset"],-677.5)
    obj[3] = hurt_side_obj_char[3]
    obj[4] = 0.75
    obj[5] = 1
    obj[6] = 1
    obj[7] = 0
    ...
    table.insert(hurt_side_obj_char["VFX_status_back_table"],obj)
end
