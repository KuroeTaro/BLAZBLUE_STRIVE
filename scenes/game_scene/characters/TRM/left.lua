...
function state_machine_char_game_scene_char_LP()
    ...
    local switch = {
        ...
        ["4SP_S_S"] = function()
            ...
            state_gate_game_scene_char_LP_from_4SP_S_S(self_side_input,opponent_side_input,self_side_obj_char,opponent_side_obj_char)
        end,
        ["4SP_S_H"] = function()
            if run_at_current_frame then
                character_animator(self_side_obj_char,self_side_obj_char["character_animation"])
...
function state_gate_game_scene_char_LP_from_4SP_S_S(self_side_input,opponent_side_input,self_side_obj_char,opponent_side_obj_char)
end
