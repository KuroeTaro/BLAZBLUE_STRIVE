...
function state_gate_game_scene_char_LP_common_ground_to_dash_move_hold_ver(input,obj_char)
    -- _4dash_backdash
...
function state_gate_game_scene_char_LP_common_air_to_dash_move_hold_ver(input,obj_char)
end
...
function state_gate_game_scene_char_LP_from_block(input,obj_char)
    ...
    if obj_char["height_state"] == "stand" then
        ...
        if state_gate_game_scene_char_LP_common_ground_to_dash_move_hold_ver(input,obj_char) then
            return true
        end
...
function state_gate_game_scene_char_LP_from_1_2_3_crouch(input,obj_char)
    ...
    -- _common_ground_idle_to_move
    if state_gate_game_scene_char_LP_common_ground_to_dash_move(input,obj_char) then
        return true
    end
...
function state_gate_game_scene_char_LP_from_7_8_9_jump_air(input,obj_char)
    ...
    if obj_char["idle_cancel"] then
        -- _common_air_idle_to_move
        if state_gate_game_scene_char_LP_common_air_to_dash_move(input,obj_char) then
            return true
        end
