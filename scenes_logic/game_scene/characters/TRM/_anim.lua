...
function load_game_scene_anim_char_TRM_j2K(obj_char)
    ...
    res[0] = function()
        ...
        obj_char["air_hurt_animation"] = load_game_scene_anim_char_TRM_j2K_hurt(obj_char)
        obj_char["air_block_animation"] = load_game_scene_anim_char_common_0_air_block(
            obj_char,
            "1_4_7_air_block",
            "air","5_stand_idle",
...
function load_game_scene_anim_char_TRM_j5Launcher(obj_char)
    ...
    res[10] = function()
        ...
        obj_char["strike_active"] = true
        -- collide
        obj_char["hitbox_table"] = {{-220,-45,190,100},{-225,-125,160,60}}
        obj_char["hurtbox_table"] = {{0,-120,250,260},{-220,-45,230,140},{-225,-125,200,100}}
        -- draw_correction
        obj_char[8] = 3
    end
    res[14] = function()
...
function load_game_scene_anim_char_TRM_j4_6Launcher(obj_char)
    ...
    res[0] = function()
        ...
        load_game_scene_anim_char_TRM_j4_6Launcher_camera_enclose_anim(obj_char)
        obj_char["enclose_position_offset"] = {0,0,0}
        -- set_frame_adv
        common_game_scene_change_character(obj_char["player_side"])["frame_adv"] = 0
        -- visual_front
...
function load_game_scene_anim_char_TRM_j4_6Launcher_land_special(obj_char)
    -- mod version of 7_8_9_jump_air_to_stand_idle
    local res = {}
...
function load_game_scene_anim_char_TRM_j4_6Launcher_camera_enclose_anim(obj_char)
    local anim = {}
    anim[0] = {0.00,1}
    anim[1] = {0.56,2}
    anim[2] = {0.70,4}
