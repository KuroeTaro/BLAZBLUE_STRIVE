...
function state_gate_game_scene_char_RP_common_to_RC_move(input,obj_char,color)
end
...
function state_gate_game_scene_char_RP_from_block(input,obj_char)
    ...
    -- _YRC
    if state_gate_game_scene_char_RP_common_to_RC_move(input,obj_char,"YRC") then
        return true
    end
    -- animation_end
...
function state_gate_game_scene_char_RP_from_throw_success(input,obj_char)
    ...
    -- _PRC
    if not obj_char["hit_cancel"] and state_gate_game_scene_char_RP_common_to_RC_move(input,obj_char,"PRC") then
        return true
    end
    -- animation_end
    if get_character_anim_end_state(obj_char,obj_char["character_animation"]) then
...
function state_gate_game_scene_char_RP_from_1_2_3_crouch(input,obj_char)
    ...
    -- _BRC
    if state_gate_game_scene_char_RP_common_to_RC_move(input,obj_char,"BRC") then
        return true
    end
    -- _7_8_9_pre_jump
...
function state_gate_game_scene_char_RP_from_burst_overdrive(input,obj_char)
    -- _PRC
    if state_gate_game_scene_char_RP_common_to_RC_move(input,obj_char,"PRC") then
        obj_char["f"] = 28
        obj_char["physics_lock"] = false
        character_animator(obj_char,obj_char["character_animation"])
        return true
...
function update_game_scene_char_RP_VFX_at_game_speed_0()
    for i = #obj_char_game_scene_char_RP["VFX_HUD_table"],1,-1 do -- 反向遍历，便于删除元素
        local object = obj_char_game_scene_char_RP["VFX_HUD_table"][i]
