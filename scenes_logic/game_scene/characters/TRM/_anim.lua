...
function load_game_scene_anim_char_TRM_6P(obj_char)
    ...
    res[0] = function()
        ...
        -- camera_animation_load
        common_game_scene_hit_load_camera_shake_anim(obj_char,0.7)
        common_game_scene_nil_load_camera_enclose_anim(obj_char)
        -- set_frame_adv
        common_game_scene_change_character(obj_char["player_side"])["frame_adv"] = 0
        -- visual_front
...
function load_game_scene_anim_char_TRM_5H_reticle_at_the_ready_locking(obj_char)
end
function load_game_scene_anim_char_TRM_5H_reticle_at_the_ready_locked(obj_char)
end
function load_game_scene_anim_char_TRM_5H_reticle_at_the_ready_unlocking(obj_char)
end
...
function load_game_scene_anim_char_TRM_5H_reticle_steady_aim_locking(obj_char)
end
function load_game_scene_anim_char_TRM_5H_reticle_steady_aim_locked(obj_char)
end
...
function load_game_scene_anim_char_TRM_jS(obj_char)
    ...
    res[19] = function()
        -- collide
        obj_char["hurtbox_table"] = {{0,-140,260,300},{130,-10,130,100},{140,-90,90,60},{140,-150,60,60}}
        -- draw_correction
        obj_char[8] = 5
    end
    res[25] = function()
...
function load_game_scene_anim_char_TRM_j4_6Launcher_success_hurt(obj_char)
    local res = {}
    local friction = 4
    local gravity = math.max(math.abs(obj_char["y"]-125)/50,7.5)
    local side = obj_char["player_side"]
    local SFX_table = common_game_scene_get_SFX_table(side)
    local obj_char_other_side = common_game_scene_change_character(side)
    local obj_camera = obj_stage_game_scene_camera
    ...
    res[0] = function()
        -- state
        obj_char_other_side["sprite_sheet_state"] = "0_general_hurt_launched_high"
        obj_char_other_side["height_state"] = "air" -- stand crouch air OTG
        obj_char_other_side["hurt_state_target"] = "unblock" -- idle unblock punish counter GP parry
        obj_char_other_side["move_state"] = "recovery" -- none startup active recovery
        obj_char_other_side["startup_frame"] = 0
        obj_char_other_side["active_frame"] = 0
    ...
    res[29] = function()
        -- 44 49 53 57 60 65 90
        -- 29 36 42 48 53 58 84
        -- state
        obj_char_other_side["y"] = 365
        obj_char_other_side["sprite_sheet_state"] = "0_general_hurt_hard_knockdown_up"
        -- state_number
