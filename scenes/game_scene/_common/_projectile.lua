function insert_projectile_game_scene_char_common_RC_shockwave_red(obj_char)
    ...
    local image_sprite_sheet_table = image_sprite_sheet_VFX_game_scene_RC_shockwave
    ...
    obj["air_hurt_animation"] = load_game_scene_anim_char_red_rc_projectile_ground_air_and_OTG_hurt(
        obj_char,obj,true,nil,
    ...
    obj["air_block_animation"] = load_game_scene_anim_char_red_rc_projectile_air_block(
        obj_char,obj,true,nil,
        "1_4_7_air_block",
        "air","5_stand_idle",
        10,5,1.00,
    ...
    obj["OTG_hurt_animation"] = load_game_scene_anim_char_red_rc_projectile_ground_air_and_OTG_hurt(
        obj_char,obj,true,nil,
        "0_general_hurt_launched_high",
        "air","knockdown_recovery",
        27,5,1.00,
    ...
    obj["wallstick_hurt_animation"] = load_game_scene_anim_char_red_rc_projectile_ground_air_and_OTG_hurt(
        obj_char,obj,true,nil,
        "0_general_hurt_launched_high",
        "air","knockdown_recovery",
        27,5,1.00,
...
function load_game_scene_anim_char_red_rc_projectile_air_block(
    obj_char,projectile,fix_direction,velocity_center,
    sprite_sheet_state,
    height_state,
    state_cache,
...
function load_game_scene_anim_char_red_rc_projectile_ground_air_and_OTG_hurt(
    obj_char,projectile,fix_direction,velocity_center,
    sprite_sheet_state,
    height_state,
    state_cache,
