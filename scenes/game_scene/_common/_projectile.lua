...
function insert_projectile_game_scene_char_common_RC_shockwave_red(hit_side_obj_char)
...
function insert_projectile_game_scene_char_common_RC_shockwave_blue(hit_side_obj_char)
    -- clear_projectile_rc_table
    hit_side_obj_char["projectile_rc_table"] = {}
    -- x y z opacity sx sy r f
    local obj_projectile = {0,0,0,1,1,1,0,0}
...
function insert_projectile_game_scene_char_common_RC_shockwave_purple(hit_side_obj_char)
    -- clear_projectile_rc_table
    hit_side_obj_char["projectile_rc_table"] = {}
    -- x y z opacity sx sy r f
    local obj_projectile = {0,0,0,1,1,1,0,0}
...
function insert_projectile_game_scene_char_common_RC_shockwave_yellow(hit_side_obj_char)
    -- clear_projectile_rc_table
    hit_side_obj_char["projectile_rc_table"] = {}
    -- x y z opacity sx sy r f
    local obj_projectile = {0,0,0,1,1,1,0,0}
...
function load_game_scene_anim_char_RC_red_projectile_ground_block(
    hit_side_obj_char,projectile,fix_direction,velocity_center,
    sprite_sheet,
    height,
    state_cache,
    ...
    res[0] = function()
        ...
        common_game_scene_projectile_apply_damage_heat(
            hit_side_obj_char,hurt_side_obj_char,"block",FD_block,projectile
        )
        ...
        -- collide
        hurt_side_obj_char["pushbox"] = pushbox_data_other_side[sprite_sheet][0]
        hurt_side_obj_char["pushbox_opponent_collision_active"] = true
        hurt_side_obj_char["hitbox_table"] = {}
        hurt_side_obj_char["hurtbox_table"] = hurtbox_data_other_side[sprite_sheet][0]
        hurt_side_obj_char["collision_ground_height_offset"] = 0
        -- draw_correction
        hurt_side_obj_char[8] = 5
        hurt_side_obj_char["anchor_pos"] = anchor_data_other_side[sprite_sheet]
        -- VFX
...
function load_game_scene_anim_char_RC_red_projectile_air_block(
    ...
    local function update_before_land()
        ...
        if collision_test_char_on_ground(hurt_side_obj_char) then
            ...
            -- collide
            hurt_side_obj_char["pushbox"] = pushbox_data_other_side[sprite_sheet][6]
            hurt_side_obj_char["hurtbox_table"] = hurtbox_data_other_side[sprite_sheet][6]
            hurt_side_obj_char["collision_ground_height_offset"] = 0
            -- draw_correction
    ...
    res[22] = function()
        -- collide
        hurt_side_obj_char["hurtbox_table"] = hurtbox_data_other_side[sprite_sheet][7]
        -- draw_correction
    ...
    res[28] = function()
        -- collide
        hurt_side_obj_char["hurtbox_table"] = hurtbox_data_other_side[sprite_sheet][8]
        -- draw_correction
...
function load_game_scene_anim_char_RC_red_projectile_ground_air_and_OTG_hurt(
    ...
    res[0] = function()
        ...
        hurt_side_obj_char["pushbox_opponent_collision_active"] = true
        hurt_side_obj_char["hitbox_table"] = {}
        hurt_side_obj_char["hurtbox_table"] = hurtbox_data_other_side[sprite_sheet][1]
        hurt_side_obj_char["collision_ground_height_offset"] = 185
        -- draw_correction
    ...
    res[9] = function()
        -- collide
        hurt_side_obj_char["hurtbox_table"] = hurtbox_data_other_side[sprite_sheet][3]
        -- draw_correction
        hurt_side_obj_char[8] = 3
        -- update
        update_before_land()
    ...
    res[15] = function()
        -- collide
        hurt_side_obj_char["hurtbox_table"] = hurtbox_data_other_side[sprite_sheet][5]
        -- draw_correction
        hurt_side_obj_char[8] = 5
        -- update
        update_before_land()
    ...
    res[27] = function()
        -- collide
        hurt_side_obj_char["hurtbox_table"] = hurtbox_data_other_side[sprite_sheet][9]
        -- draw_correction
