...
function load_game_scene_obj_char_LP()
    ...
    obj_char_game_scene_char_LP["air_move"] = {1, 1}
...
function order_load_game_scene_char_LP_frames(load_order)
    ...
    -- image_table_char_game_scene_LP_oroboros = {}
    -- image_table_char_game_scene_LP_oroboros["stand_idle_hold"] = {}
    -- image_table_char_game_scene_LP_oroboros["stand_idle_shoot"] = {}
    -- for i = 0,3 do
    --     image_table_char_game_scene_LP_oroboros["stand_idle_hold"][i] = love.graphics.newImage(ASSET_DATA[1]["LP_oroboros"]["stand_idle_hold"][i])
    -- end
    -- for i = 0,9 do
    --     image_table_char_game_scene_LP_oroboros["stand_idle_shoot"][i] = love.graphics.newImage(ASSET_DATA[1]["LP_oroboros"]["stand_idle_shoot"][i])
    -- end
...
function load_game_scene_box_anchor_data_LP()
    ...
    obj_VFX_spawn_anchor_pos_data_game_scene_char_LP["smoke_spawn_anchor_pos"]["1_4_7_air_block"] = {-367,-165}
    ...
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_semi_launched_mid"][4] = crouch_pushbox
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_semi_launched_mid"][6] = stand_pushbox
    ...
    obj_hurtboxs_data_game_scene_char_LP["0_general_hurt_semi_launched_mid"][1] = {{0, -100, 285, 390}}
    obj_hurtboxs_data_game_scene_char_LP["0_general_hurt_semi_launched_mid"][3] = {{0, -190, 270, 380}}
    obj_hurtboxs_data_game_scene_char_LP["0_general_hurt_semi_launched_mid"][4] = {{0, -182.5, 250, 365}}
    obj_hurtboxs_data_game_scene_char_LP["0_general_hurt_semi_launched_mid"][6] = {{0, -175, 255, 350}}
    obj_hurtboxs_data_game_scene_char_LP["0_general_hurt_semi_launched_mid"][7] = {{0, -205, 215, 410}}
    obj_anchor_data_game_scene_char_LP["0_general_hurt_semi_launched_mid"] = {275, 515}
...
function state_machine_char_game_scene_char_LP()
    ...
    local switch = {
        ...
        -- 待机状态
            ...
            -- 4_6_walk -> 4_6_walk_to_stand_idle
            -- 6_dash -> 6_dash_to_stand_idle
                -- 4_dash不是待机状态
            -- 2_crouch -> 2_crouch_to_stand_idle
            -- 7_8_9_jump_air -> 7_8_9_jump_air_to_stand_idle
                -- pre_jump 不是idle(不能拉防)
                -- air是(可以拉防)
        ["1_2_3_crouch"] = function()
            character_animator(obj_char,obj_char["current_animation"])
            state_gate_game_scene_char_LP_common_ground_idle_to_move(input,obj_char)
            -- _4_walk
            ...
            -- _1_2_3_crouch_turn
            if common_game_scene_get_character_facing_currect(obj_char) then
        ...
        ["1_2_3_crouch_turn"] = function()
            character_animator(obj_char,obj_char["current_animation"])
            state_gate_game_scene_char_LP_from_crouch_idle(input,obj_char)
        end,
        ["1_2_3_crouch_to_stand_idle"] = function()
            character_animator(obj_char,obj_char["current_animation"])
            state_gate_game_scene_char_LP_from_crouch_to_stand_idle(input,obj_char)
        end,
        ...
        ["7_8_9_jump_air"] = function()
            character_animator(obj_char,obj_char["current_animation"])
            if obj_char["velocity"][2] > 0.0 and test_char_on_ground(obj_char) then
                obj_char["y"] = 365
                obj_char["collision_test_ground_height_offset"] = 0
                obj_char["current_animation"] = load_game_scene_anim_char_TRM_jump_air_to_stand_idle(obj_char)
                obj_char["state"] = "7_8_9_jump_air_to_stand_idle"
                init_character_anim_with(obj_char,obj_char["current_animation"])
            end
            state_gate_game_scene_char_LP_from_jump_air(input,obj_char)
        end,
        ["7_8_9_jump_air_to_stand_idle"] = function()
            ...
            if obj_char["idle_cancel"] then
                ...
                state_gate_game_scene_char_LP_from_jump_air_to_stand_idle(input,obj_char)
            end
        end,
        ...
        ["7_8_9_pre_jump"] = function()
            character_animator(obj_char,obj_char["current_animation"])
            if common_game_scene_get_character_animation_end(obj_char) then
                local relative_side = common_game_scene_get_character_relative_side(obj_char)
                if obj_char["direction_input_cache"] == 7 then
                    obj_char["velocity_cache"][1] = obj_char["velocity_cache"][1]*0.1 - relative_side*9.0
                    obj_char["current_animation"] = load_game_scene_anim_char_TRM_7_8_9_jump(obj_char,"7_jump",{202,568})
                elseif obj_char["direction_input_cache"] == 8 then
                    obj_char["velocity_cache"][1] = obj_char["velocity_cache"][1]*0.1
                    obj_char["current_animation"] = load_game_scene_anim_char_TRM_7_8_9_jump(obj_char,"8_jump",{350,585})
                elseif obj_char["direction_input_cache"] == 9 then
                    obj_char["velocity_cache"][1] = obj_char["velocity_cache"][1]*0.1 + relative_side*9.0
                    obj_char["current_animation"] = load_game_scene_anim_char_TRM_7_8_9_jump(obj_char,"9_jump",{300,500})
                end
                obj_char["y"] = 225
        ...
        ["burst_overdrive"] = function()
            character_animator(obj_char,obj_char["current_animation"])
            if test_input_sys_press(input["RC"]) and obj_char["move_state"] == "recovery" then
                -- to OD_RC
                return
            end
            if common_game_scene_get_character_animation_end(obj_char) then
        ...
        ["5P"] = function()
            ...
            if obj_char["hit_cancel"] and obj_char["move_state"] == "recovery" then
                obj_char["input_sys_state"] = "load" -- none save load
                state_machine_char_game_scene_char_LP_input_sys_cache()
...
function state_gate_game_scene_char_LP_from_stand_idle(input,obj_char)
    local facing_currect_flag = false
    if common_game_scene_get_character_facing_currect(obj_char) then
        facing_currect_flag = true
        if facing_currect_flag then
            obj_char[5] = -obj_char[5]
        end
    end
    ...
    if obj_char["direction_input"] == 5 and facing_currect_flag then
        -- stand_idle_turn
    end
...
function state_gate_game_scene_char_LP_from_jump_air(input,obj_char)

end

function state_gate_game_scene_char_LP_from_jump_air_to_stand_idle(input,obj_char)
    if common_game_scene_get_character_animation_end(obj_char) then
        obj_char["current_animation"] = load_game_scene_anim_char_TRM_5_stand_idle(obj_char)   
        obj_char["state"] = "5_stand_idle"
        init_character_anim_with(obj_char,obj_char["current_animation"])
...
function state_gate_game_scene_char_LP_common_ground_idle_to_move(input,obj_char)
    ...
    -- _6P
    -- _5P
    if test_input_sys_press(input["P"]) and not common_game_scene_check_jump_direction(obj_char) then
        -- to 5P
        obj_char["current_animation"] = load_game_scene_anim_char_TRM_5P(obj_char)
        init_character_anim_with(obj_char,obj_char["current_animation"])
        obj_char["state"] = "5P"
