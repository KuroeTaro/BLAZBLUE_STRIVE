...
thread_data["HUD_ease_in_sprite_batch"] = compress_module("asset/game_scene/common/HUD/HUD_ease_in.dds")
thread_data["HUD_common_sprite_batch"] = non_compress_module("asset/game_scene/common/HUD/HUD_common.png")
thread_data["HUD_background_gauge"] = compress_module("asset/game_scene/common/HUD/HUD_background_gauge.dds")
