...
function order_load_game_scene_char_LP_frames(load_order)
    ...
    local switch = 
    {
        ...
        -- UA 超必杀 (预留槽)
        [34] = function()
            image_sprite_sheet_table_UA_game_scene_LP = image_sprite_sheet_table_UA_game_scene_LP or {}
            local load_name_table = {
            }
            for i,v in ipairs(load_name_table) do
...
function order_load_game_scene_char_LP_audio(load_order)
    ...
    if load_order == 1 then
        ...
        for key, sound_data in pairs(PLAYER_AUDIO_DATA["stage_interactive_SFX"]) do
            ...
            audio_SFX_game_scene_stage_interactive_SFX_LP[key]["audio"] = love.audio.newSource(sound_data,"static")
    ...
    for i = start_index,end_index do
        ...
        audio_SFX_game_scene_move_SFX_LP[key]["audio"] = love.audio.newSource(PLAYER_AUDIO_DATA["move_SFX"][key],"static")
...
function state_machine_char_game_scene_char_LP()
    ...
    local switch = {
        ...
        ["j5S"] = function()
            ...
            state_gate_game_scene_char_LP_from_j5S(input,self_side_obj_char,opponent_side_obj_char)
        end,
        ["j2S"] = function()
            if run_at_current_frame then
                character_animator(self_side_obj_char,self_side_obj_char["character_animation"])
...
function state_gate_game_scene_char_LP_from_j5P(input,self_side_obj_char,opponent_side_obj_char)
    -- _PRC
    if state_gate_game_scene_char_LP_common_to_burst_RC_purple(input,self_side_obj_char,opponent_side_obj_char) then
        return true
    end
