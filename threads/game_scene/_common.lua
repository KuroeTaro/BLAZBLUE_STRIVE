...
thread_data["audio_annoucer_ease_in"] = sound_module("asset/game_scene/common/audio/annoucer_ease_in.mp3")
thread_data["audio_overdrive"] = sound_module("asset/game_scene/common/audio/overdrive.mp3")
