...
function load_game_scene_obj_char_LP()
    ...
    init_input_sys_cache_negative_edge(obj_char_game_scene_char_LP)
    ...
    obj_char_game_scene_char_LP["characte_animation"] = nil
    obj_char_game_scene_char_LP["characte_animation_length"] = 0
    ...
    obj_char_game_scene_char_LP["oroboros_front_offset"] = {-80,-80}
...
function update_game_scene_char_LP_revise()
end
...
function state_gate_game_scene_char_LP_from_throw_testing(input,obj_char)
    ...
    if obj_char["f"] <= 9 and common_game_scene_change_input_state("L")["Launcher"] == "Pressing" then
...
function state_gate_game_scene_char_LP_oroboros_from_off(input,obj_char)
end
function state_gate_game_scene_char_LP_oroboros_from_ease_in(input,obj_char)
end
function state_gate_game_scene_char_LP_oroboros_from_ease_out(input,obj_char)
end
function state_gate_game_scene_char_LP_oroboros_from_loop(input,obj_char)
end
function state_gate_game_scene_char_LP_oroboros_from_shot(input,obj_char)
end
