...
function state_gate_game_scene_char_RP_from_throw_success(input,obj_char)
    ...
    -- _RRC
    if obj_char["hit_cancel"] and state_gate_game_scene_char_RP_common_burst_RC_red(input,obj_char) then
        return true
    end
    -- _PRC
...
function state_gate_game_scene_char_RP_from_hitstop(input,obj_char)
    ...
    if obj_char["hit_hurt_blockstop_countdown"] <= 0 then
        ...
        -- _RRC
        if state_gate_game_scene_char_RP_common_burst_RC_red(input,obj_char) then
            return true
        end
