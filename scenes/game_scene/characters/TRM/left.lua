...
function load_game_scene_obj_char_LP()
    ...
    obj_char_game_scene_char_LP["game_speed_common_cache"] = {1,0,0}
    obj_char_game_scene_char_LP["game_speed_cache_after_apply"] = {0,1,1,0,0}
    ...
    obj_char_game_scene_char_LP["game_speed_pause_countdown"] = 0 -- 只能是game_speed的倍数
