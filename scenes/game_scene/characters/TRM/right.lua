...
function state_machine_char_game_scene_char_RP()
    ...
    local switch = {
        ...
        ["4SP_S_5UA"] = function()
            ...
            state_gate_game_scene_char_RP_from_4SP_S_5UA(self_side_input,opponent_side_input,self_side_obj_char,opponent_side_obj_char)
        end
    }
    if run_at_current_frame then
...
function state_gate_game_scene_char_RP_from_4SP_S_5UA(self_side_input,opponent_side_input,self_side_obj_char,opponent_side_obj_char)
end
-- draw
...
function draw_game_scene_char_RP_VFX_front()
    for i = 1,#obj_char_game_scene_char_RP["VFX_common_front_table"],1 do -- 反向遍历，便于删除元素
        local object = obj_char_game_scene_char_RP["VFX_common_front_table"][i]
        object["draw"]()
    end
    for i = 1,#obj_char_game_scene_char_RP["VFX_status_front_table"],1 do -- 反向遍历，便于删除元素
        local object = obj_char_game_scene_char_RP["VFX_status_front_table"][i]
        object["draw"]()
    end
...
function draw_game_scene_char_RP_VFX_back()
    for i = 1,#obj_char_game_scene_char_RP["VFX_common_back_table"],1 do -- 反向遍历，便于删除元素
        local object = obj_char_game_scene_char_RP["VFX_common_back_table"][i]
        object["draw"]()
    end
    for i = 1,#obj_char_game_scene_char_RP["VFX_status_back_table"],1 do -- 反向遍历，便于删除元素
        local object = obj_char_game_scene_char_RP["VFX_status_back_table"][i]
        object["draw"]()
    end
