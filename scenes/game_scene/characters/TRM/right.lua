...
function load_game_scene_obj_char_RP()
    ...
    obj_char_game_scene_char_RP["whiff_SFX"] = nil
    -- 5H_shot_sys
...
function load_game_scene_audio_char_RP()
    ...
    audio_SFX_game_scene_common_SFX_RP = {}
    ...
    for i = 1, #file_name_table do
        ...
        audio_SFX_game_scene_common_SFX_RP[key] = {1, LCT = {0}, LCD = {0}}
        audio_SFX_game_scene_common_SFX_RP[key]["audio"] = love.audio.newSource(path, "static")
        update_SFX_VOLUME(audio_SFX_game_scene_common_SFX_RP[key])
    end
    -- slash_SFX
    file_name_table = {
    ...
    audio_SFX_game_scene_move_SFX_RP["oroboros_in_normal"] = {1, LCT = {0}, LCD = {0}}
    audio_SFX_game_scene_move_SFX_RP["oroboros_in_normal"]["audio"] = 
    love.audio.newSource("asset/game_scene/characters/TRM/audio/move_SFX/oroboros_in_normal.wav", "static")
    update_SFX_VOLUME(audio_SFX_game_scene_move_SFX_RP["oroboros_in_normal"])
    -- 2P_SFX
    file_name_table = {
