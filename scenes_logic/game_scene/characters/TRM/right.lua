...
function load_game_scene_obj_char_RP()
    ...
    obj_char_game_scene_char_RP["default_pushbox_width"] = 120
    ...
    obj_char_game_scene_char_RP["hit_jump_use_direction_input_cache"] = 5
...
function state_gate_game_scene_char_RP_common_ground_to_attack_move(input,obj_char)
    ...
    -- _cS
    if test_input_sys_press(input["S"]) and collision_test_cS_distance_check(obj_char,375) then
        if not common_game_scene_get_character_facing_currect(obj_char) then
            obj_char[5] = -obj_char[5]
        end
...
function state_gate_game_scene_char_RP_common_ground_to_attack_move_hold_ver(input,obj_char)
    ...
    -- _cS
    if test_input_sys_press_or_hold(input["S"]) and collision_test_cS_distance_check(obj_char,375) then
        if not common_game_scene_get_character_facing_currect(obj_char) then
            obj_char[5] = -obj_char[5]
        end
        obj_char["character_animation"] = load_game_scene_anim_char_TRM_cS(obj_char)
