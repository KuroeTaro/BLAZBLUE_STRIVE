...
function load_game_scene_box_anchor_data_RP()
    ...
    obj_anchor_data_game_scene_char_RP["0_general_hurt_soft_knockdown_wallstick_air"] = {215,315}
    ...
    obj_anchor_data_game_scene_char_RP["0_general_hurt_hard_knockdown_wallstick_ground"] = {215,380}
