...
function load_game_scene_obj_char_LP()
    ...
    obj_char_game_scene_char_LP["game_speed_abnormal_realtime_countdown"] = 0 -- 慢放持续的真实帧数(建议为game_speed的倍数)
    obj_char_game_scene_char_LP["game_speed_force_0_countdown"] = 0 -- 全停冻结的帧数(real frame)
    ...
    obj_char_game_scene_char_LP["shot_sys_at_the_ready_instant_aim_state"] = {
        ["block"] = true,
        ["hurt"] = true,
        ["throw_hurt_success"] = true,
        ["blockstop"] = true,
    ...
    obj_char_game_scene_char_LP["shot_sys_at_the_ready_6SP_S_pass_state"] = {
        ["at_the_ready_ease_out"] = true,
        ["at_the_steady_to_off"] = true,
        ["off"] = true
    }
    obj_char_game_scene_char_LP["shot_sys_at_the_ready_state_table"] = {
    ...
    obj_char_game_scene_char_LP["shot_sys_at_the_steady_quick_clean_hit_state"] = {
        ["hurt"] = true,
        ["throw_hurt_success"] = true,
        ["hurtstop"] = true,
        ["wallstick"] = true,
    ...
    obj_char_game_scene_char_LP["shot_sys_at_the_steady_quick_clean_hit_from_at_the_ready_state"] = {
        ["block"] = true,
        ["blockstop"] = true
    }
    obj_char_game_scene_char_LP["shot_sys_at_the_steady_state_table"] = {
...
function load_game_scene_box_anchor_data_LP()
    ...
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_hard_recovery_down"][4] = crouch_pushbox
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_hard_recovery_down"][7] = stand_pushbox
    ...
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_hard_recovery_up"][0] = OTG_pushbox
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_hard_recovery_up"][4] = crouch_pushbox
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_hard_recovery_up"][7] = stand_pushbox
    ...
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_hard_recovery_wallstick_ground"][0] = OTG_pushbox
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_hard_recovery_wallstick_ground"][1] = crouch_pushbox
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_hard_recovery_wallstick_ground"][2] = stand_pushbox
    ...
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_soft_recovery_ground"][0] = stand_pushbox
    obj_pushboxs_data_game_scene_char_LP["0_general_hurt_soft_recovery_ground"][4] = stand_pushbox
...
function state_machine_char_game_scene_char_LP()
    ...
    local switch = {
        ...
        ["4SP_S_H"] = function()
            ...
            state_gate_game_scene_char_LP_from_4SP_S_H(self_side_input,opponent_side_input,self_side_obj_char,opponent_side_obj_char)
        end,
...
-- 状态机连接门
-- to_gate
function state_gate_game_scene_char_LP_common_ground_to_dash_move(self_side_input,opponent_side_input,self_side_obj_char,opponent_side_obj_char)
    -- direction_input
...
function state_gate_game_scene_char_LP_common_ground_to_dash_move_hold_ver_all(self_side_input,opponent_side_input,self_side_obj_char,opponent_side_obj_char)
    -- direction_input
    if not common_game_scene_get_character_facing_currect(self_side_obj_char,opponent_side_obj_char) and test_input_sys_press_or_hold(self_side_input["dash"]) then
        self_side_obj_char[5] = -self_side_obj_char[5]
    end
...
function state_gate_game_scene_char_LP_common_ground_to_dash_move_hold_ver_6dash_only(self_side_input,opponent_side_input,self_side_obj_char,opponent_side_obj_char)
    -- direction_input
    if not common_game_scene_get_character_facing_currect(self_side_obj_char,opponent_side_obj_char) and test_input_sys_press_or_hold(self_side_input["dash"]) then
        self_side_obj_char[5] = -self_side_obj_char[5]
    end
...
function state_gate_game_scene_char_LP_common_ground_to_dash_move_hold_ver_4dash_to_walk(self_side_input,opponent_side_input,self_side_obj_char,opponent_side_obj_char)
    -- direction_input
    if not common_game_scene_get_character_facing_currect(self_side_obj_char,opponent_side_obj_char) and test_input_sys_press_or_hold(self_side_input["dash"]) then
        self_side_obj_char[5] = -self_side_obj_char[5]
    end
