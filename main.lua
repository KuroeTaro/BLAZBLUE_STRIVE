...
function love.load()
	...
	DEBUG_TRAINNING_SPAWN_ARRAY[0][0] = {-2039.25,-2039.25+320,1,-1}
	DEBUG_TRAINNING_SPAWN_ARRAY[0][1] = {-2039.25+320,-2039.25,-1,1}
	DEBUG_TRAINNING_SPAWN_ARRAY[1][0] = {-320,320,1,-1}
	DEBUG_TRAINNING_SPAWN_ARRAY[1][1] = {320,-320,-1,1}
	DEBUG_TRAINNING_SPAWN_ARRAY[2][0] = {2039.25-320,2039.25,1,-1}
	DEBUG_TRAINNING_SPAWN_ARRAY[2][1] = {2039.25,2039.25-320,-1,1}
